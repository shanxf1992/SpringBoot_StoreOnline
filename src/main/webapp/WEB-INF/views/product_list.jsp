...
<div class="row" style="width:1210px;margin:0 auto;">
    ...
    <c:forEach items="${pageBean.products}" var="product">
        <div class="col-md-2" style="height: 260px;">
            ...
            <p><a href="javascript:void(0)" style='color:green'>${product.pname}</a></p>
...
<div style="width:380px;margin:0 auto;margin-top:50px;">
    <ul class="pagination" style="text-align:center; margin-top:10px;">
        <li>
            ...
            <c:if test="${pageBean.page != 1}">
                <a href="product_list?page=${pageBean.page -1}&rows=12" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
            </c:if>
        </li>
        ...
        <c:forEach begin="1" end="${pageBean.totalPage}" step="1" var="i">
            ...
            <c:if test="${i != pageBean.page}">
                <li><a href="product_list?page=${i}&rows=12">${i}</a></li>
            </c:if>
        ...
        <li>
            ...
            <c:if test="${pageBean.page != pageBean.totalPage}">
                <a href="product_list?page=${pageBean.page+1}&rows=12" aria-label="Next"> <span aria-hidden="true">&raquo;</span> </a>
            </c:if>
        </li>
    </ul>
</div>
